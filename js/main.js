$(document).ready(function() {
    ...
    // $("#logo a").hover(
    //     function() {
    //         // Mouse enter: Add animations or other actions if needed
    //         $(this).animate({ letterSpacing: '2px' }, 'fast');
    //     },
    //     function() {
    //         // Mouse leave: Revert to the original state
    //         $(this).animate({ letterSpacing: '0' }, 'fast');
    //     }
    // );
